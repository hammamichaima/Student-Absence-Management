...
public class Login {
	...
	public void loginView() {
		...
		Admin hm = new Admin();
		Enseignant tview = new Enseignant();
		Etudiant sview = new Etudiant();
		
		//-------------------------LOGO--------------------------
		JLabel attendance = new JLabel("GESTION ");
		...
		JLabel management = new JLabel("DES ABSENCES");
